...
switch ($idade) {
    ...
    case ($idade < 5):
    echo "Não pode participar do campeonato: Idade não acançou o minimo!";
    break;
    ...
    case 9:
    case 10:
    echo "Categoria: Infanti   / ", "Nome: $nome"; 
    break;
    ...
    case 14:
    case 15:
    echo "Categoria: Juvenil    / ", "Nome: $nome"; 
    break;
    ...
    case 19:
    case 20:   
    echo "Categoria: Júnior   / ", "Nome: $nome"; 
    break;
    ...
    case 24:
    case 25:
    echo "Categoria: Profissional   / ", "Nome: $nome"; 
    break;

    default:
    echo "Não pode participar do campeonato: Idade muito avançada!";
    break;
}
...
?>
          ...
          <a href="./programaclube.php"> <center>  <button class="button">Voltar</button><br><br> </center> </a>
