...
<div class="gradient-background"></div>
 ...
 <center><div class='justify-center'> <hr> </div></center>  <br>

          <center> <span class="texto06"> Fórmulario de cadastro </span> </center>

           <br> <center><div class='justify-center'> <hr> </div></center> 

          <form method="post" action="./calculoproduto.php">

          <span class="texto02">  <p> Regitre o código do produto: </p> </span>
          <input type="number" step="0.01" name="codigo" placeholder="Código do produto"> <br><br>

          <button class="button">Consutar</button><br><br>
